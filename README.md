...
Internes Meeting-Booking-System mit öffentlicher Buchungsseite, einem zentralen Admin, Google Calendar/Meet pro Mitarbeiter, globalem HubSpot Sync und SMTP-Versand pro Mitarbeiter.

## Server

Die App läuft für den ersten VPS-Test auf:
...
HubSpot Token und SMTP-Passwörter werden verschlüsselt in der Datenbank gespeichert, nicht in `.env`.
...
Es gibt zwei getrennte OAuth-Aktionen über denselben Callback:
...
Für Server-Cronjobs den Header setzen:
