...
export default function BookingPageClient({ employee, callerSlug }) {
    ...
    try {
      const response = await fetch("/api/book", {
        ...
        body: JSON.stringify({
          ...
          callerSlug: callerSlug || undefined,
        }),
      });
      ...
      <div className={styles.shell}>
        ...
        {step === 3 && booking && selectedSlot && (
          <section className={`${styles.panel} ${styles.confirmation}`}>
            ...
            <p>Die E-Mail mit Bestätigungslink und ICS wurde an {booking.email} gesendet.</p>
            <p>
