    ...
    <main className={styles.page}>
      <section className={styles.shell}>
        <div className={result.type === "success" ? styles.successBox : styles.errorBox}>
          ...
          {result.type === "success" ? (
            <>
              <p>Danke, der Termin ist jetzt als bestaetigt markiert.</p>
              {result.meetLink && <a href={result.meetLink}>Google Meet oeffnen</a>}
            </>
          ) : (
            <>
              <p>Bitte pruefen Sie den Link aus Ihrer E-Mail.</p>
